---
title: "Analysis and Design of a Modular Self-Balance High-Voltage Input DC–DC Topology"
collection: publications
category: manuscripts
permalink: /publication/Analysis and Design of a Modular Self-Balance High-Voltage Input DC–DC Topology
excerpt: >-
  In high-voltage (HV) input to low-voltage (LV) output dc/dc conversion applications, the input series output parallel (ISOP) structure is widely used and studied. Practically, the ISOP system encounters the below challenges: 1) HV isolated components, such...
date: 2022-01-06
venue: 'IEEE Journal of Emerging and Selected Topics in Power Electronics'
paperurl: 'https://doi.org/10.1109/JESTPE.2022.3140898'
citation: 'Z. Xiao et al., "Analysis and Design of a Modular Self-Balance High-Voltage Input DC–DC Topology," in IEEE Journal of Emerging and Selected Topics in Power Electronics, vol. 10, no. 2, pp. 2276-2289, April 2022, doi: 10.1109/JESTPE.2022.3140898.'
---
...
<figure class="publication-figure">
  <img src="/images/Analysis and Design of a Modular Self-Balance High-Voltage Input DC–DC Topology.webp" loading="lazy" decoding="async" alt="Analysis and Design of a Modular Self-Balance High-Voltage Input DC–DC Topology">
</figure>
