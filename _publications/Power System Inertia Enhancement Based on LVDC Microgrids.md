...
excerpt: >-
  There is a critical need to increase power system inertia during the grid transformation. However, in a low-voltage dc (LVDC) microgrid, many potential inertia contributors, such as energy storage systems, are linked to the local dc bus and managed by...
date: 2024-12-09
venue: 'IEEE Transactions on Industrial Electronics'
paperurl: 'https://doi.org/10.1109/TIE.2024.3508069'
...
<figure class="publication-figure">
  <img src="/images/Power System Inertia Enhancement Based on LVDC Microgrids.webp" loading="lazy" decoding="async" alt="Power System Inertia Enhancement Based on LVDC Microgrids">
</figure>
